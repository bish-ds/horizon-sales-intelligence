...
# Load Inter & Outfit fonts and apply custom styling
st.markdown("""
    ...
    [data-testid="stVerticalBlockBorderOnly"] {
    ...
    [data-testid="stVerticalBlockBorderOnly"]:hover {
    ...
    /* Style default metric elements in case they are rendered */
...
st.sidebar.image("https://cdn-icons-png.flaticon.com/512/3308/3308395.png", width=60)
st.sidebar.markdown("<h2 style='margin-top: 10px; font-size: 24px; color: #F8FAFC;'>Horizon</h2>", unsafe_allow_html=True)
st.sidebar.markdown("<p style='font-size: 14px; opacity: 0.7; margin-top: -10px; color: #94A3B8;'>Sales & Profitability Hub</p>", unsafe_allow_html=True)
st.sidebar.markdown("---")

st.sidebar.markdown("<h3 style='font-size: 16px; color: #F8FAFC;'>🎛️ Filters</h3>", unsafe_allow_html=True)
...
# Title Header
st.markdown("<h1 style='font-size: 38px; margin-bottom: 5px; color: #F8FAFC;'>📈 USA Regional Sales Intelligence</h1>", unsafe_allow_html=True)
